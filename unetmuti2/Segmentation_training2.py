...
conv12 = Conv2D(class_num, 1, activation='softmax', padding='same', kernel_initializer='he_normal')(conv11)
# outputs = Conv2D(1, 1, activation='relu') (conv12)
model = Model(input=inputs, output=conv12)
# print(model.summary())
model.compile(optimizer=Adamax(lr=1e-4), loss='categorical_crossentropy', metrics=['accuracy'])
